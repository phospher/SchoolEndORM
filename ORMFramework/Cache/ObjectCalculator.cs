...
namespace ORMFramework.Cache {
    public static class ObjectCalculator {
        ...
        private static bool CalculateBooleanOperator ( bool x, bool y, Operator @operator ) {
            switch ( @operator ) {
                case Operator.And: return x && y;
                case Operator.Or: return x || y;
        ...
        private static bool CalculateNotBooleanOperator ( double x, double y, Operator @operator ) {
            switch ( @operator ) {
                case Operator.Equals: return x == y;
                case Operator.Greater: return x > y;
                case Operator.GreaterEquals: return x >= y;
                case Operator.Less: return x < y;
                case Operator.LessEquals: return x <= y;
                case Operator.UnEquals: return x != y;
                default: throw new Exception ( "Invalid Statement" );
            }
        }
